          ...
          <div className="wrap">
            <header>
              <Link href="/">
                <a className="logo-link">
                  <img src={require("../static/assets/logo-lite.png?webp?inline")} alt="My Logo" />
                </a>
              </Link>
            ...
            <footer>
              <div className="copyright">
                <p>© 2018 <a href="https://otbeaumont.me">Oscar Beaumont</a>, powered by <a href="https://nextjs.org/" target="_blank" rel="external nofollow noopener noreferrer">Next.js </a> and modified styles from the <a href="https://github.com/pinggod/hexo-theme-apollo" target="_blank">hexo-theme-apollo</a>.</p>
                <div className="services">


                  <a href="https://github.com/oscartbeaumont" target="_blank" className="social-icon">
                    <img src={require("../static/img/rss.png?webp?inline")} alt="Github" />
                  </a>

                  <a href="https://open.spotify.com/user/oscartbeaumont" target="_blank" className="social-icon">
                    <img src={require("../static/img/spotify.png?webp?inline")} alt="Spotify" />
                  </a>

                  <a href="mailto:oscartbeaumont@gmail.com" target="_blank" className="social-icon">
                    <img src={require("../static/img/email.png?webp?inline")} alt="Email" />
                  </a>

                  <a href="https://otbeaumont.me/atom.xml" target="_blank" className="social-icon">
                    <img src={require("../static/img/rss.png?webp?inline")} alt="RSS" />
                  </a>
                </div>
              </div>
            </footer>
