...
const assets: Asset[] = [
  { filename: "OscarBeaumontLogo-White.png", path: "/assets/OscarBeaumontLogo-White.png", type: "image" },
  { filename: "OscarBeaumontLogo.ai", path: "/assets/OscarBeaumontLogo.ai", type: "vector" },
  { filename: "OscarBeaumontLogo.png", path: "/assets/OscarBeaumontLogo.png", type: "image" },
  ...
  { filename: "me-original.jpg", path: "/assets/me-original.jpg", type: "image" },
  { filename: "me.jpg", path: "/assets/me.jpg", type: "image" },
  { filename: "me2.jpg", path: "/assets/me2.jpg", type: "image" },
  { filename: "minecraft-skin.png", path: "/assets/minecraft-skin.png", type: "image" },
...
const AssetCard = (props: { asset: Asset }) => (
  <div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-200">
    ...
    <div class="p-4 bg-white">
      <div class="font-medium text-gray-900 mb-2 truncate" title={props.asset.filename}>
