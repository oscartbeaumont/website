	...
	return (
		<>
			<div class="h-1/5 w-full bg-[#1f65a6] text-white flex justify-between p-8">
				<div class="pt-5">
					<img
						src="/assets/OscarBeaumontLogo-White.png"
						alt="Oscar Beaumont Logo"
						class="h-12"
					/>
		...
		<div class="w-125 bg-black/70 backdrop-blur-xl p-4 flex flex-col space-y-4 fixed top-0 bottom-0 right-0">
			...
			<div class="flex">
				<input
					...
					onChange={(e) =>
						(props.state.invoiceId = parseInt(e.currentTarget.value, 10))
					}
					placeholder="0000"
				/>
				<button
			...
			<input
				...
				onChange={(e) =>
					(props.state.dueInDays = parseInt(e.currentTarget.value, 10))
				}
				placeholder="14"
			/>
