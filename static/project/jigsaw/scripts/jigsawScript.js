...
function jigsaw(canvasID, imageID, rows, columns, tileXoffset, tileYoffset, callback, movesCallback) {
    var MAIN_IMG_WIDTH = 800; // 800
    var MAIN_IMG_HEIGHT = 600; // 600


    var BLOCK_IMG_WIDTH = 600; // 600
    var BLOCK_IMG_HEIGHT = 450; // 450
    ...
    function handleOnMouseDown(e) {
        ...
        selectedBlock = GetImageBlock(imageBlockList, e.pageX, e.pageY-55);
    ...
    function handleOnMouseMove(e) {
        ...
        if (selectedBlock) {
            ...
            selectedBlock.x = e.pageX - tileXoffset; //  - 25;
            selectedBlock.y = e.pageY - tileYoffset; //  - 25;
